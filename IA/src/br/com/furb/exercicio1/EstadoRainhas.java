...
/**
 * Representa um estado do mundo: onde estï¿½o as rainhas
 */
public class EstadoRainhas implements Estado, Heuristica, Aleatorio {
    ...
    /**
     *  cria um estado inicial (aleatï¿½rio)
     */
        ...
        for (short r=0;r<tam;r++) { // para cada rainha
            ...
            for (int c=0; c<tam; c++) {
                ...
                if (naPos != -1) { // não esta livre
                    if (naPos != r) { // não ï¿½ r que esta la
                        ataques++;
                    }
                }
            }
            ...
            for (int l=0; l<tam; l++) {
                ...
                if (naPos != -1) { // nï¿½o esta livre
                    if (naPos != r) { // nao ï¿½ r que esta la
                        ataques++;
                    }
                }
            }
            ...
            // testa as diagonais secundï¿½rias
